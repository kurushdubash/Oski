...
def gym_info(audio):
    ...
    if 'hours' in audio or 'close' in audio:
        return audio + 'Sun: 8am - 1am<br>' + 'Mon: 6am - 1am<br>' + 'Tue: 6am - 1am<br>' + 'Wed: 6am - 1am<br>' + 'Thu: 6am - 1am<br>' + 'Fri: 6am - 11pm<br>' + 'Sat: 8am - 11pm<br>'
    ...
    if 'open' in audio or 'closed' in audio:
        ...
        if(day_of_week < 6 and hours >= 6):
            if(day_of_week == 4 and hours > 23):
                return audio + "<br>Gym closed!"
            else:
                return audio + "<br>Gym open!"
